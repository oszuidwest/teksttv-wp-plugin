...
final class TaxonomyFilters
{
    ...
    public static function render_selects(int|string $index, array $filters, string $prefix): void
    {
        ...
        <div class="teksttv-block-field">
            ...
            <select name="<?php echo esc_attr($prefix); ?>[<?php echo esc_attr((string) $index); ?>][taxonomy_filters][<?php echo esc_attr($tax['name']); ?>][]" class="teksttv-tomselect" data-placeholder="<?php echo esc_attr__('Filter...', 'teksttv-wp-plugin'); ?>" data-summary data-summary-empty="<?php echo esc_attr__('alle', 'teksttv-wp-plugin'); ?>" multiple>
