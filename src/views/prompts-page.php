...
<div class="teksttv-tab-content">
    <form method="post" action="options.php" class="teksttv-settings-form">
        ...
        <div class="teksttv-card">
            ...
            <table class="form-table teksttv-form-table">
                <tr>
                    <th scope="row"><label for="teksttv_ai_min_input"><?php echo esc_html('Minimum input'); ?></label></th>
                    <td>
                ...
                <tr>
                    <th scope="row"><label for="teksttv_ai_max_retries"><?php echo esc_html('Max pogingen'); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php echo esc_html('Aantal pogingen als de output niet binnen het limiet valt. Elke extra poging kost een API-call.'); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="teksttv_ai_rate_limit"><?php echo esc_html('Rate limit'); ?></label></th>
                    <td>
        ...
        <div class="teksttv-card">
            ...
            <table class="form-table teksttv-form-table">
                <tr>
                    <th scope="row"><label for="teksttv_ai_region_taxonomy"><?php echo esc_html('Taxonomy'); ?></label></th>
                    <td>
        ...
        <div class="teksttv-card">
            ...
            <table class="form-table teksttv-form-table">
                <tr>
                    <th scope="row"><label for="teksttv_ai_temperature"><?php echo esc_html('Temperature'); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php echo esc_html('Creativiteit van de output. 0 = deterministisch, 1 = standaard, 2 = zeer creatief. Leeg = provider default.'); ?></p>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php echo esc_html('Nucleus sampling. Lagere waarde = meer gefocust. Leeg = provider default.'); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="teksttv_ai_max_tokens"><?php echo esc_html('Max tokens'); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php echo esc_html('Maximaal aantal tokens in de AI-response. Standaard 2048.'); ?></p>
                    </td>
                </tr>
            </table>
        </div>
