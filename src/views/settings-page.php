...
<div class="teksttv-tab-content" x-data="teksttvSettingsPage">
    <form method="post" action="options.php" class="teksttv-settings-form">
            ...
            <table class="widefat teksttv-channels-table" id="teksttv-channels" @click="channelsClick($event)">
                ...
                <tbody>
                    ...
                    <tr class="teksttv-channel-row">
                        <td><input type="text" name="teksttv_channels[<?php echo $i; ?>][slug]" value="<?php echo esc_attr($ch['slug']); ?>" class="regular-text" pattern="[a-z0-9\-]+" required placeholder="<?php echo esc_attr__('bijv. tv1', 'teksttv'); ?>" /></td>
                        <td><input type="text" name="teksttv_channels[<?php echo $i; ?>][label]" value="<?php echo esc_attr($ch['label']); ?>" class="regular-text" required placeholder="<?php echo esc_attr__('bijv. TV 1', 'teksttv'); ?>" /></td>
        ...
        <!-- Features -->
        <div class="teksttv-card">
            <h3><?php esc_html_e('Post editor features', 'teksttv'); ?></h3>
            <p class="description"><?php esc_html_e('Bepaal welke opties beschikbaar zijn bij het bewerken van een post.', 'teksttv'); ?></p>
        ...
        <!-- Slide duur -->
        <div class="teksttv-card">
            <h3><?php esc_html_e('Slide duur', 'teksttv'); ?></h3>
            <p class="description"><?php esc_html_e('Standaard weergaveduur per slide type. Kan per post worden overschreven.', 'teksttv'); ?></p>
            <table class="form-table teksttv-form-table">
                <tr>
                    <th scope="row"><label for="teksttv_duration_text"><?php esc_html_e('Tekstslide', 'teksttv'); ?></label></th>
                    <td>
                        <input type="number" id="teksttv_duration_text" name="teksttv_duration_text" value="<?php echo esc_attr(get_option('teksttv_duration_text', 20)); ?>" min="1" max="120" class="small-text" /> <?php esc_html_e('seconden', 'teksttv'); ?>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="teksttv_duration_image"><?php esc_html_e('Afbeeldingslide', 'teksttv'); ?></label></th>
                    <td>
                        <input type="number" id="teksttv_duration_image" name="teksttv_duration_image" value="<?php echo esc_attr(get_option('teksttv_duration_image', 7)); ?>" min="1" max="120" class="small-text" /> <?php esc_html_e('seconden', 'teksttv'); ?>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <!-- Taxonomies -->
        <div class="teksttv-card">
            <h3><?php esc_html_e('Taxonomy filters', 'teksttv'); ?></h3>
            <p class="description"><?php esc_html_e('Kies welke taxonomies beschikbaar zijn als filter in de loop-blokken.', 'teksttv'); ?></p>
            <fieldset class="teksttv-checkbox-list">
        ...
        <!-- Standaardwaarden -->
        <div class="teksttv-card">
            <h3><?php esc_html_e('Standaardwaarden', 'teksttv'); ?></h3>
            <p class="description"><?php esc_html_e('Standaard instellingen voor nieuwe Tekst TV items op posts.', 'teksttv'); ?></p>
            <table class="form-table teksttv-form-table">
                <tr>
                    <th scope="row"><label for="teksttv_default_end_days"><?php esc_html_e('Standaard einddatum', 'teksttv'); ?></label></th>
                    <td>
                        ...
                        <?php esc_html_e('dagen na publicatiedatum', 'teksttv'); ?>
                        <p class="description"><?php esc_html_e('Stel 0 in om geen standaard einddatum te gebruiken.', 'teksttv'); ?></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="teksttv_max_post_age"><?php esc_html_e('Maximale leeftijd berichten', 'teksttv'); ?></label></th>
                    <td>
                        ...
                        <?php esc_html_e('dagen', 'teksttv'); ?>
                        <p class="description"><?php esc_html_e('Berichten ouder dan dit worden niet meegenomen. Stel 0 in voor geen limiet.', 'teksttv'); ?></p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <!-- Weather -->
        <div class="teksttv-card">
            <h3><?php esc_html_e('Weer', 'teksttv'); ?></h3>
            <p class="description"><?php esc_html_e('OpenWeather API configuratie voor weer-slides.', 'teksttv'); ?></p>
            <table class="form-table teksttv-form-table">
                <tr>
                    <th scope="row"><label for="teksttv_openweather_api_key"><?php esc_html_e('API key', 'teksttv'); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php echo wp_kses(__('OneCall API 3.0 key van <a href="https://openweathermap.org/api" target="_blank" rel="noopener">openweathermap.org</a>.', 'teksttv'), ['a' => ['href' => [], 'target' => [], 'rel' => []]]); ?></p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <!-- Preview -->
        <div class="teksttv-card">
            <h3><?php esc_html_e('Preview', 'teksttv'); ?></h3>
            <p class="description"><?php esc_html_e('Configureer de live preview die getoond wordt bij het bewerken van posts.', 'teksttv'); ?></p>
            <table class="form-table teksttv-form-table">
                <tr>
                    <th scope="row"><label for="teksttv_preview_url"><?php esc_html_e('Preview URL', 'teksttv'); ?></label></th>
                    <td>
                        ...
                        <p class="description"><?php esc_html_e('De volledige URL naar de TekstTV frontend preview pagina.', 'teksttv'); ?></p>
                    </td>
                </tr>
            </table>
        </div>
